        ...
        <section className="space-y-6">
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1">
              <Mail />
              <a href="mailto:ncharanaraj@gmail.com">ncharanaraj@gmail.com</a>
            </div>
            <div className="flex items-center gap-1">
              <MapPin />
              <p>Karnataka, India</p>
          ...
          <div className="space-y-4 max-w-lg">
            ...
            <p>
              I develop reusable UI components, integrate REST APIs, and deliver
              clean, accessible interfaces. I'm comfortable working in Agile
              teams and use tools like Git, Figma, and Jira, while continuously
              learning and optimizing for performance.
            </p>
            <p>
              I'm actively seeking frontend developer roles where I can
              contribute, collaborate with skilled teams, and continue growing
              as a React engineer. Open to remote opportunities.
            </p>
          </div>
